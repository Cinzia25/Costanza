  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: positions
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      vicon_receiver::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.positions[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: positions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vicon_receiver::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.positions[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vicon_receiver
max_serialized_size_key_PositionList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: positions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vicon_receiver::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Position(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
